...
* :mod:`claimtrace.pipeline` mechanically resolves the exact contract, method
...
def validate_method_assessment_document(document: object) -> None:
    ...
    if document.get("derived") != expected_derived:
        raise MethodAssessmentError("derived content does not match Claimtrace policy output")
